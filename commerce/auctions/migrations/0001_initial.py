    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('current_bid', models.DecimalField(decimal_places=2, default=0, max_digits=32)),
        ...
        migrations.AddField(
            model_name='user',
            name='my_watchlist',
            field=models.ManyToManyField(blank=True, related_name='watched_items', to='auctions.Item'),
        ),
        migrations.AddField(
            model_name='user',
